...
module.exports = Any.extend({
    ...
    messages: {
        'string.alphanum': '{{#label}} deve contenere solo caratteri alphanumerici',
        'string.base': '{{#label}} deve essere una stringa',
        'string.base64': '{{#label}} deve essere una stringa base64', //pbly wrong
        'string.creditCard': '{{#label}} deve essere una carta di credito',
        'string.dataUri': '{{#label}} deve essere una dataUri string',
        'string.domain': '{{#label}} deve contenere un valido domain name',
        'string.email': '{{#label}} deve contenere una valida email',
        'string.empty': '{{#label}} non puo essere vuoto',
        'string.guid': '{{#label}} must be a valid GUID', //got bored
        ...
        'string.length': '{{#label}} deve essere lungo piu di {{#limit}} caratteri',
